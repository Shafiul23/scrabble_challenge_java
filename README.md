...
This challenge revisits the first challenge set by Digital Futures Academy, but this time in Java instead of JavaScript. 
It extends on the criteria from the previous challenge in that this programme can now account for double / triple words and letters.
The scrabble challenge was written test-first, and implements concepts such as HashMaps and encapsulation! 
